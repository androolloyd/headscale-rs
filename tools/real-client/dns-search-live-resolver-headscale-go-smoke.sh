...
fixture_work_root="${REAL_CLIENT_DNS_LIVE_RESOLVER_WORKDIR:-target/real-client/dns-search-live-resolver-headscale-go-fixture}"
...
REAL_CLIENT_WORKDIR="${REAL_CLIENT_WORKDIR:-target/real-client/dns-search-live-resolver-headscale-go-smoke}" \
...
REAL_CLIENT_DNS_SPLIT_NAMESERVERS_JSON="${REAL_CLIENT_DNS_SPLIT_NAMESERVERS_JSON:-${DNS_LIVE_SEARCH_SPLIT_NAMESERVERS_JSON}}" \
REAL_CLIENT_DNS_SEARCH_DOMAINS_JSON="${REAL_CLIENT_DNS_SEARCH_DOMAINS_JSON:-${DNS_LIVE_SEARCH_DOMAINS_JSON}}" \
REAL_CLIENT_EXPECT_MAGIC_DNS_SUFFIX="${REAL_CLIENT_EXPECT_MAGIC_DNS_SUFFIX:-${base_domain}}" \
REAL_CLIENT_EXPECT_DNS_DOMAINS="${REAL_CLIENT_EXPECT_DNS_DOMAINS:-${DNS_LIVE_SEARCH_EXPECT_DNS_DOMAINS}}" \
REAL_CLIENT_EXPECT_DNS_ROUTES="${REAL_CLIENT_EXPECT_DNS_ROUTES:-${DNS_LIVE_SEARCH_EXPECT_DNS_ROUTES}}" \
REAL_CLIENT_EXPECT_DNS_RESOLVER_OBJECTS="${REAL_CLIENT_EXPECT_DNS_RESOLVER_OBJECTS:-true}" \
REAL_CLIENT_EXPECT_DNS_DEBUG_RESOLVES="${REAL_CLIENT_EXPECT_DNS_DEBUG_RESOLVES:-${DNS_LIVE_SEARCH_EXPECT_DNS_DEBUG_RESOLVES}}" \
