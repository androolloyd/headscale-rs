...
asserts a non-default MagicDNS suffix over that production Postgres path, and
the `postgres-extra-records` variant asserts configured DNS `extra_records` in
the stock-client netmap:
