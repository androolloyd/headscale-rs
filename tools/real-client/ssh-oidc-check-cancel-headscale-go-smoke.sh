...
REAL_CLIENT_OIDC_SSH_DENY_STATUS="${REAL_CLIENT_OIDC_SSH_DENY_STATUS:-124}" \
...
REAL_CLIENT_WORKDIR="${REAL_CLIENT_WORKDIR:-target/real-client/ssh-oidc-check-cancel-headscale-go-smoke}" \
