...
REAL_CLIENT_WORKDIR="${REAL_CLIENT_WORKDIR:-target/real-client/postgres-route-via-multiprefix-reload-headscale-go-smoke}" \
...
REAL_CLIENT_ROUTE_VIA_NO_RESTART=true \
REAL_CLIENT_RESTART_ROUTE="${REAL_CLIENT_RESTART_ROUTE:-${REAL_CLIENT_ROUTE:-10.77.0.0/24}}" \
REAL_CLIENT_RESTART_ROUTE_B="${REAL_CLIENT_RESTART_ROUTE_B:-${REAL_CLIENT_ROUTE_B:-10.88.0.0/24}}" \
