...
REAL_CLIENT_WORKDIR="${REAL_CLIENT_WORKDIR:-target/real-client/route-primary-withdraw-headscale-go-smoke}" \
...
REAL_CLIENT_EXPECT_PRIMARY_WITHDRAW_ROUTE="${REAL_CLIENT_EXPECT_PRIMARY_WITHDRAW_ROUTE:-${route}}" \
REAL_CLIENT_EXPECT_WITHDRAW_APPROVAL_PRESERVED="${REAL_CLIENT_EXPECT_WITHDRAW_APPROVAL_PRESERVED:-true}" \
