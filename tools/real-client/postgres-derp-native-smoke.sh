...
region_id="${REAL_CLIENT_DERP_REGION_ID:-941}"
region_code="${REAL_CLIENT_DERP_REGION_CODE:-native}"
region_name="${REAL_CLIENT_DERP_REGION_NAME:-headscale-rs native DERP}"
...
REAL_CLIENT_WORKDIR="${REAL_CLIENT_WORKDIR:-target/real-client/postgres-derp-native-smoke}" \
