...
REAL_CLIENT_CLIENT_USERS="${REAL_CLIENT_CLIENT_USERS:-${ssh_user}@example.com,${ssh_user}@example.com,${ssh_user}@other.example,${ssh_user}@other.example,${ssh_user},${ssh_user}}" \
...
REAL_CLIENT_CLIENT_USERS="${REAL_CLIENT_PROFILE_ROOT_DENY_CLIENT_USERS:-${ssh_user}@example.com,${ssh_user}@example.com}" \
