...
ssh_user="${REAL_CLIENT_SSH_USER:-ssh-profile-user}"
...
REAL_CLIENT_CLIENT_USER_EMAILS="${REAL_CLIENT_CLIENT_USER_EMAILS:-${ssh_user}@example.com,${ssh_user}@example.com,${ssh_user}@other.example,${ssh_user}@other.example,-,-}" \
...
REAL_CLIENT_CLIENT_USER_EMAILS="${REAL_CLIENT_PROFILE_ROOT_DENY_CLIENT_USER_EMAILS:-${ssh_user}@example.com,${ssh_user}@example.com}" \
...
REAL_CLIENT_CLIENT_USERS="${REAL_CLIENT_PROFILE_CASE_DOMAIN_CLIENT_USERS:-profile-owner,profile-owner}" \
REAL_CLIENT_CLIENT_USER_EMAILS="${REAL_CLIENT_PROFILE_CASE_DOMAIN_CLIENT_USER_EMAILS:-${case_domain_client_email},${case_domain_client_email}}" \
