...
smoke_assertions=(
  ...
  "production Postgres native DERP stock clients reconnect and relay after Rust server restart"
  ...
  "production Postgres dual-stack-to-IPv4-only backfill after prefix-family removal"
  "production Postgres dual-stack-to-IPv6-only backfill after prefix-family removal"
