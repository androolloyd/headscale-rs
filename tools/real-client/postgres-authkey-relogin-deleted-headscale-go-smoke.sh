...
REAL_CLIENT_WORKDIR="${REAL_CLIENT_WORKDIR:-target/real-client/postgres-authkey-relogin-deleted-headscale-go-smoke}" \
...
REAL_CLIENT_AUTHKEY_RELOGIN_DELETED=true \
