-- Minimal SQLite dump shape from headscale-go v0.28.0-beta.1.
-- The schema has the renamed tags column and bcrypt columns, but it predates
-- the v0.28 RequestTags migration that headscale-rs requires for import.
