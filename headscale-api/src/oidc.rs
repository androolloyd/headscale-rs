...
mod tests {
    ...
    #[test]
    fn oidc_claim_identifier_matches_upstream_types_cases() {
        for (name, iss, sub, expected) in [
            (
                "standard URL with trailing slash",
                "https://oidc.example.com/",
                "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
                "https://oidc.example.com/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
            ),
            (
                "standard URL without trailing slash",
                "https://oidc.example.com",
                "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
                "https://oidc.example.com/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
            ),
            (
                "standard URL with uppercase protocol",
                "HTTPS://oidc.example.com/",
                "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
                "https://oidc.example.com/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
            ),
            (
                "standard URL with path and trailing slash",
                "https://login.microsoftonline.com/v2.0/",
                "I-70OQnj3TogrNSfkZQqB3f7dGwyBWSm1dolHNKrMzQ",
                "https://login.microsoftonline.com/v2.0/I-70OQnj3TogrNSfkZQqB3f7dGwyBWSm1dolHNKrMzQ",
            ),
            (
                "non-URL identifier with trailing slash",
                "oidc/",
                "sub",
                "oidc/sub",
            ),
            ("subject with slash", "oidc/", "sub/", "oidc/sub"),
            ("whitespace", "   oidc/   ", "   sub   ", "oidc/sub"),
            ("newline", "\noidc/\n", "\nsub\n", "oidc/sub"),
            ("tab", "\toidc/\t", "\tsub\t", "oidc/sub"),
            ("empty issuer", "", "sub", "sub"),
            (
                "empty subject",
                "https://oidc.example.com",
                "",
            ...
            (
                "FTP URL protocol",
                "ftp://example.com/directory",
                "resource",
                "ftp://example.com/directory/resource",
            ),
        ] {
            ...
            let actual = claims.identifier();
            assert_eq!(actual, expected, "{name}");
            assert_eq!(clean_identifier(&actual), expected, "{name}");
        }
    }
