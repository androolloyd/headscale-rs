...
work_root="${REAL_CLIENT_WORKDIR:-target/real-client/postgres-ssh-localpart-headscale-go-smoke}"
...
REAL_CLIENT_CLIENT_USERS="${REAL_CLIENT_LOCALPART_PLUS_ROOT_CLIENT_USERS:-${localpart_ssh_user},eve}" \
REAL_CLIENT_CLIENT_USER_EMAILS="${REAL_CLIENT_LOCALPART_PLUS_ROOT_CLIENT_USER_EMAILS:-${localpart_ssh_user}@example.com,eve@example.com}" \
