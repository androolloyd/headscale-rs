...
fixture_work_root="${REAL_CLIENT_DNS_LIVE_RESOLVER_WORKDIR:-target/real-client/dns-multi-resolver-fallback-headscale-go-fixture}"
...
REAL_CLIENT_WORKDIR="${REAL_CLIENT_WORKDIR:-target/real-client/dns-multi-resolver-fallback-headscale-go-smoke}" \
