...
REAL_CLIENT_WORKDIR="${REAL_CLIENT_WORKDIR:-target/real-client/postgres-prefix-family-v4-to-dual-backfill-magicdns-restart-headscale-go-smoke}" \
REAL_CLIENT_PREFIX_MIGRATION_TARGET=headscale-go \
REAL_CLIENT_PREFIX_MIGRATION_CASE=v4-to-dual \
REAL_CLIENT_PREFIX_MIGRATION_EDGE=magicdns-peer-restart \
