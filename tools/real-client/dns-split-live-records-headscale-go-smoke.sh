...
split_suffix="${REAL_CLIENT_DNS_LIVE_SPLIT_SUFFIX:-records.${base_domain}}"
fixture_work_root="${REAL_CLIENT_DNS_LIVE_RESOLVER_WORKDIR:-target/real-client/dns-split-live-records-headscale-go-fixture}"
...
export REAL_CLIENT_DNS_LIVE_SPLIT_NAME="${REAL_CLIENT_DNS_LIVE_SPLIT_NAME:-v4.${split_suffix}}"
export REAL_CLIENT_DNS_LIVE_SPLIT_IPV4="${REAL_CLIENT_DNS_LIVE_SPLIT_IPV4:-203.0.113.70}"
export REAL_CLIENT_DNS_LIVE_SPLIT_IPV6_NAME="${REAL_CLIENT_DNS_LIVE_SPLIT_IPV6_NAME:-v6.${split_suffix}}"
export REAL_CLIENT_DNS_LIVE_SPLIT_IPV6="${REAL_CLIENT_DNS_LIVE_SPLIT_IPV6:-2001:db8::70}"
...
REAL_CLIENT_WORKDIR="${REAL_CLIENT_WORKDIR:-target/real-client/dns-split-live-records-headscale-go-smoke}" \
...
REAL_CLIENT_EXPECT_DNS_DEBUG_RESOLVES="${REAL_CLIENT_EXPECT_DNS_DEBUG_RESOLVES:-${DNS_LIVE_SPLIT_RESOLVE_EXPECTATIONS}}" \
